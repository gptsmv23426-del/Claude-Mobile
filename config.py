...
class Config:
    ...
    MIN_MARKET_VOLUME_USD: float = float(os.environ.get("MIN_MARKET_VOLUME_USD", "500"))
    MAX_SPREAD: float = float(os.environ.get("MAX_SPREAD", "0.15"))
    MIN_EVIDENCE_QUALITY: float = float(os.environ.get("MIN_EVIDENCE_QUALITY", "0.40"))
    MIN_EDGE_THRESHOLD: float = float(os.environ.get("MIN_EDGE_THRESHOLD", "0.05"))
